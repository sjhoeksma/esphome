...
namespace esphome
{
  namespace modbus
  {
    ...
    protected:
      ...
      SnifferMode sniffer_mode[256];
      uint16_t sniffer_count[256];
    };
    ...
    public:
      ...
      virtual void on_modbus_sniffer_registers(uint8_t function_code, uint16_t start_address, uint16_t number_of_registers) {};
